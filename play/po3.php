...
<div class="title"><p>Top 10 Punjabi Songs</p></div>
...
<br>
<?php
$ret=mysqli_query($conn,"select id,filename,picname,song,album FROM audios LIMIT 14,10 ");
			...
			<div class="music-name">
				...
				<p><?php echo $row['album'] ?></p>
                        ...
                        <p class="lnk-wishlist">
							<a class="add-to-cart" href="po3.php?id=<?php echo htmlentities($row['id'])?>&&action=favourites" title="Favourites">
								 <i class="icon fa fa-heart"></i>&nbsp;&nbsp;&nbsp;
							</a>
						</p>
                        <p class="lnk-wishlist">
							<a class="add-to-cart" href="po3.php?id=<?php echo htmlentities($row['id'])?>&&action=queue" title="queue">
