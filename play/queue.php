...
{
$query=mysqli_query($conn,"DELETE FROM queue WHERE id='" . $_GET["id"] . "'");
}
?>
...
<br>
<?php
$ret=mysqli_query($conn,"select audios.filename as filename,audios.picname as picname,audios.song as song,audios.album as album,queue.sid as pid,queue.id as wid from queue join audios on audios.id=queue.id");
			...
			<div class="music-name">
				...
				<p><?php echo $row['album'] ?></p>
                        ...
                        <p class="lnk-wishlist">
							<a class="add-to-cart" href="queue.php?id=<?php echo htmlentities($row['wid'])?>&&action=favourites" title="Favourites">
								 <i class="icon fa fa-heart"></i>&nbsp;&nbsp;&nbsp;
							</a>
						</p>
                        <p class="lnk-wishlist">
							<a class="add-to-cart" href="queue.php?id=<?php echo htmlentities($row['wid'])?>&&action=remove" title="queue">
